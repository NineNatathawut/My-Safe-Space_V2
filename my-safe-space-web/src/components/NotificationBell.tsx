  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="relative p-2.5 bg-gray-50 hover:bg-gray-100 rounded-full transition-colors text-gray-600"
      >
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-80 md:w-96 bg-white rounded-2xl shadow-xl border border-gray-100 z-[100] overflow-hidden">
            ...
            {notifications.length === 0 ? (
              ...
              notifications.slice(0, 10).map((n) => (
                  <div
                    ...
                    className={`cursor-pointer block px-4 py-3 hover:bg-gray-50 transition-colors border-b border-gray-50 last:border-0 ${!n.is_read ? 'bg-indigo-50/40' : ''}`}
                  >
